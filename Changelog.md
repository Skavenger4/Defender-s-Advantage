...
Version 1.7.0 (Pom-Poms + Not the morale boosting kind + Centipides are too weak Edition)
	Added Single, Dual, Quad, Oct. variants (Single available in seige)
	[QF 2 pounder (All)] 
		- Range of 200 due to low muzzle velocity
		- RoF 120RPM
		- Increased shot spread to prevent many rounds hitting the same spot with larger mounts
		- Minimum range of 12 for static (Seige Nil)
		- Could target locations
	Single
		- 56 rounds (could fire for ~28 Seconds)
		- 1x1
		- nil power req.
		- Seige available
	Dual
		- 168 rounds (could fire for ~42 Seconds)
		- 2x2
		- nil power req.
	Quad
		- 448 rounds (could fire for ~56 Seconds)
		- 2x2
		- 1500 watts power req.
	Octuple
		- 1120 rounds (could fire for ~80 Seconds)
		- 3x2
		- 3000 watts power req.
		- @ 15.7 tonnes it would be extraordinarily difficult to put on a caravan
		[You would Probably want 50 spare colonists + 200 Muffalos + Sufficent Batteries]
		[Ignoring the ammunition of course . . .]
	Uses the 40x158mm round, each gun takes different linked belts for synchronous fire
	(dual Fires 2 shots, Quad Fires 4 ect.)
	Sheep wool 
		Name Change
		- Sheep Wool -> Reclaimed Wool
	Reduced time of [Redacted] to improve progress
	Probably going to Change the 25mm AC to the same synchronous fire as the pom - poms
	Considering The consideration of adding the 6 pounder for future proofing. . .
	Considering the glaring consideration of adding a more armored centipide. . .
	~*Rest in peace Windows 7, The only good 64 bit Os*~
	
Version 1.7.1 (Bug Xploding + Actually tested Editon)
	Fixed bug where all 40mm HEAT Rounds do no damage
	Added a readable Changelog due to windows 10 issues
	Fixed *Most* bad grammar in descriptions
	Added Senario ~Recently Liberated and Very Lost~
	Name Change 
		Type 2.5 -> Type 2-B 
